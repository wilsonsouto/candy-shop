namespace CandyShop.Helpers
{
    internal static class MessageHelper
    {
        ...
        internal const string InvalidName =
            "The product name cannot be empty and must be between 3 and 20 characters. Try again: ";
        ...
        internal const string InvalidShape =
            "The shape cannot be empty and must be between 3 and 20 characters. Try again: ";
    }
}
